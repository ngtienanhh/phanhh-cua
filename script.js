...
document.getElementById("noBtn").addEventListener("click", function () {
  switch (noButtonState) {
    ...
    case 4:
      ...
      break;
    case 5:
      document.getElementById("noBtn").innerHTML = " Đã nói là không mà";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 6:
      ...
      break;
    case 7:
      document.getElementById("noBtn").innerHTML = " Tớ chịu thua đấy ! ";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
      ...
      document.getElementById("noBtn").onclick = function() {  
        if (confirm("CẬU THẬT SỰ KHÔNG YÊU PHƯƠNG ANH SAO?")) {  
